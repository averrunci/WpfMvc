...
{
    TodoItem TodoItem { get; } = new(InitialContent);
    ...
    void Ex03()
    {
        ...
        Then("it should be requested to remove the to-do", () => RemoveRequestedHandler.Received(1).Invoke(TodoItem, EventArgs.Empty));
    }
