...
namespace Fievus.Windows.Mvc
{
    ...
    public class WindowRequestedEvent
    {
        ...
        /// </returns>
        public static WindowRequestedEvent Modal() => new WindowRequestedEvent { modal = true };
        ...
        /// The instance of the <see cref="WindowRequestedEvent"/> class.
        /// </returns>
        public static WindowRequestedEvent Modeless() => new WindowRequestedEvent();
        ...
        {
            element.RequireNonNull(nameof(element));
