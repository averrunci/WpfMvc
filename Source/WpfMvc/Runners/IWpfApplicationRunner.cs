...
namespace Charites.Windows.Runners
{
    ...
    public interface IWpfApplicationRunner<out T> where T : Application
    {
        /// <summary>
        ...
        /// <summary>
        /// Runs the specified action with data on the WPF application thread.
        /// </summary>
        /// <param name="action">The action with data to run on the WPF application thread.</param>
        /// <returns>The instance of the <see cref="IWpfApplicationRunner{T}"/> interface.</returns>
        IWpfApplicationRunner<T> Run(Action<T, WpfApplicationDataContext> action);
