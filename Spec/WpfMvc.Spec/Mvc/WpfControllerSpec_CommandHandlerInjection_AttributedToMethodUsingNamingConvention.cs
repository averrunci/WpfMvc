...
namespace Charites.Windows.Mvc
{
    ...
    class WpfControllerSpec_CommandHandlerInjection_AttributedToMethodUsingNamingConvention : FixtureSteppable
    {
        ...
        void Ex01()
        {
            TestWpfControllers.AttributedToMethodUsingNamingConvention.OneArgumentExecutedOnlyHandlerController controller = null;
            ...
            Given("a controller that has command handlers", () =>
            {
                ...
                controller = new TestWpfControllers.AttributedToMethodUsingNamingConvention.OneArgumentExecutedOnlyHandlerController(HandleExecutedEvent);
            });
        ...
        void Ex02()
        {
            TestWpfControllers.AttributedToMethodUsingNamingConvention.OneArgumentExecutedAndCanExecuteHandlerController controller = null;
            ...
            Given("a controller that has command handlers", () =>
            {
                ...
                controller = new TestWpfControllers.AttributedToMethodUsingNamingConvention.OneArgumentExecutedAndCanExecuteHandlerController(HandleExecutedEvent, HandleCanExecuteEvent);
            });
        ...
        void Ex03()
        {
            ...
            Given("a controller that has command handlers", () =>
            {
                ...
                controller = new TestWpfControllers.AttributedToMethodUsingNamingConvention.OneArgumentExecutedAndCanExecuteHandlerController(HandleExecutedEvent1, HandleCanExecuteEvent1, HandleExecutedEvent2, HandleCanExecuteEvent2);
            });
        ...
        void Ex04()
        {
            TestWpfControllers.AttributedToMethodUsingNamingConvention.ExecutedOnlyHandlerController controller = null;
            ...
            Given("a controller that has command handlers", () =>
            {
                ...
                controller = new TestWpfControllers.AttributedToMethodUsingNamingConvention.ExecutedOnlyHandlerController(HandleExecutedEvent);
            });
        ...
        void Ex05()
        {
            TestWpfControllers.AttributedToMethodUsingNamingConvention.ExecutedAndCanExecuteHandlerController controller = null;
            ...
            Given("a controller that has command handlers", () =>
            {
                ...
                controller = new TestWpfControllers.AttributedToMethodUsingNamingConvention.ExecutedAndCanExecuteHandlerController(HandleExecutedEvent, HandleCanExecuteEvent);
            });
        ...
        void Ex06()
        {
            ...
            Given("a controller that has command handlers", () =>
            {
                ...
                controller = new TestWpfControllers.AttributedToMethodUsingNamingConvention.ExecutedAndCanExecuteHandlerController(HandleExecutedEvent1, HandleCanExecuteEvent1, HandleExecutedEvent2, HandleCanExecuteEvent2);
            });
