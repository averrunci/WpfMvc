...
namespace Charites.Windows.Mvc
{
    ...
    class WpfControllerSpec_CommandHandlerInjection_AttributedToProperty : FixtureSteppable
    {
        ...
        void Ex01()
        {
            TestWpfControllers.AttributedToProperty.OneArgumentExecutedOnlyHandlerController controller = null;
            ...
            Given("a controller that has command handlers", () =>
            {
                ...
                controller = new TestWpfControllers.AttributedToProperty.OneArgumentExecutedOnlyHandlerController(HandleExecutedEvent);
            });
        ...
        void Ex02()
        {
            TestWpfControllers.AttributedToProperty.OneArgumentExecutedAndCanExecuteHandlerController controller = null;
            ...
            Given("a controller that has command handlers", () =>
            {
                ...
                controller = new TestWpfControllers.AttributedToProperty.OneArgumentExecutedAndCanExecuteHandlerController(HandleExecutedEvent, HandleCanExecuteEvent);
            });
        ...
        void Ex03()
        {
            ...
            Given("a controller that has command handlers", () =>
            {
                ...
                controller = new TestWpfControllers.AttributedToProperty.OneArgumentExecutedAndCanExecuteHandlerController(HandleExecutedEvent1, HandleCanExecuteEvent1, HandleExecutedEvent2, HandleCanExecuteEvent2);
            });
        ...
        void Ex04()
        {
            TestWpfControllers.AttributedToProperty.ExecutedOnlyHandlerController controller = null;
            ...
            Given("a controller that has command handlers", () =>
            {
                ...
                controller = new TestWpfControllers.AttributedToProperty.ExecutedOnlyHandlerController(HandleExecutedEvent);
            });
        ...
        void Ex05()
        {
            TestWpfControllers.AttributedToProperty.ExecutedAndCanExecuteHandlerController controller = null;
            ...
            Given("a controller that has command handlers", () =>
            {
                ...
                controller = new TestWpfControllers.AttributedToProperty.ExecutedAndCanExecuteHandlerController(HandleExecutedEvent, HandleCanExecuteEvent);
            });
        ...
        void Ex06()
        {
            ...
            Given("a controller that has command handlers", () =>
            {
                ...
                controller = new TestWpfControllers.AttributedToProperty.ExecutedAndCanExecuteHandlerController(HandleExecutedEvent1, HandleCanExecuteEvent1, HandleExecutedEvent2, HandleCanExecuteEvent2);
            });
