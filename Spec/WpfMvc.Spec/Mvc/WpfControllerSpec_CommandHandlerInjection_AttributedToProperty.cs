...
{
    [Context("The command handlers are attributed to properties")]
    class WpfControllerSpec_CommandHandlerInjection_AttributedToProperty : FixtureSteppable, IDisposable
    {
        ...
        public WpfControllerSpec_CommandHandlerInjection_AttributedToProperty()
        {
        ...
        void Ex01()
        {
            ...
            Given("a controller that has command handlers", () => WpfRunner.Run((application, context) =>
            {
                ...
                context.Set(ControllerKey, new TestWpfControllers.AttributedToProperty.OneArgumentExecutedOnlyHandlerController(HandleExecutedEvent));
            }));

            When("the controller is added", () => WpfRunner.Run((application, context) => WpfController.GetControllers(context.Get<TestElement>(ElementKey)).Add(context.Get<TestWpfControllers.AttributedToProperty.OneArgumentExecutedOnlyHandlerController>(ControllerKey))));
        ...
        void Ex02()
        {
            ...
            Given("a controller that has command handlers", () => WpfRunner.Run((application, context) =>
            {
                ...
                context.Set(ControllerKey, new TestWpfControllers.AttributedToProperty.OneArgumentExecutedAndCanExecuteHandlerController(HandleExecutedEvent, HandleCanExecuteEvent));
            }));

            When("the controller is added", () => WpfRunner.Run((application, context) => WpfController.GetControllers(context.Get<TestElement>(ElementKey)).Add(context.Get<TestWpfControllers.AttributedToProperty.OneArgumentExecutedAndCanExecuteHandlerController>(ControllerKey))));
            When("the controller is attached to the element", () => WpfRunner.Run((application, context) => WpfController.GetControllers(context.Get<TestElement>(ElementKey)).AttachTo(context.Get<TestElement>(ElementKey))));
            When("the Initialized event is raised", () => WpfRunner.Run((application, context) => context.Get<TestElement>(ElementKey).RaiseInitialized()));
        ...
        void Ex03()
        {
            ...
            Given("a controller that has command handlers", () => WpfRunner.Run((application, context) =>
            {
                ...
                context.Set(ControllerKey, new TestWpfControllers.AttributedToProperty.OneArgumentExecutedAndCanExecuteHandlerController(HandleExecutedEvent1, HandleCanExecuteEvent1, HandleExecutedEvent2, HandleCanExecuteEvent2));
            }));
        ...
        void Ex04()
        {
            ...
            Given("a controller that has command handlers", () => WpfRunner.Run((application, context) =>
            {
                ...
                context.Set(ControllerKey, new TestWpfControllers.AttributedToProperty.ExecutedOnlyHandlerController(HandleExecutedEvent));
            }));

            When("the controller is added", () => WpfRunner.Run((application, context) => WpfController.GetControllers(context.Get<TestElement>(ElementKey)).Add(context.Get<TestWpfControllers.AttributedToProperty.ExecutedOnlyHandlerController>(ControllerKey))));
            When("the controller is attached to the element", () => WpfRunner.Run((application, context) => WpfController.GetControllers(context.Get<TestElement>(ElementKey)).AttachTo(context.Get<TestElement>(ElementKey))));
            When("the Initialized event is raised", () => WpfRunner.Run((application, context) => context.Get<TestElement>(ElementKey).RaiseInitialized()));
        ...
        void Ex05()
        {
            ...
            Given("a controller that has command handlers", () => WpfRunner.Run((application, context) =>
            {
                ...
                context.Set(ControllerKey, new TestWpfControllers.AttributedToProperty.ExecutedAndCanExecuteHandlerController(HandleExecutedEvent, HandleCanExecuteEvent));
            }));

            When("the controller is added", () => WpfRunner.Run((application, context) => WpfController.GetControllers(context.Get<TestElement>(ElementKey)).Add(context.Get<TestWpfControllers.AttributedToProperty.ExecutedAndCanExecuteHandlerController>(ControllerKey))));
            When("the controller is attached to the element", () => WpfRunner.Run((application, context) => WpfController.GetControllers(context.Get<TestElement>(ElementKey)).AttachTo(context.Get<TestElement>(ElementKey))));
            When("the Initialized event is raised", () => WpfRunner.Run((application, context) => context.Get<TestElement>(ElementKey).RaiseInitialized()));
        ...
        void Ex06()
        {
            ...
            Given("a controller that has command handlers", () => WpfRunner.Run((application, context) =>
            {
                ...
                context.Set(ControllerKey, new TestWpfControllers.AttributedToProperty.ExecutedAndCanExecuteHandlerController(HandleExecutedEvent1, HandleCanExecuteEvent1, HandleExecutedEvent2, HandleCanExecuteEvent2));
            }));
