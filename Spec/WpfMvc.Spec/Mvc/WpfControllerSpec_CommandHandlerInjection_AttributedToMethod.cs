...
{
    [Context("The command handlers are attributed to methods")]
    class WpfControllerSpec_CommandHandlerInjection_AttributedToMethod : FixtureSteppable, IDisposable
    {
        ...
        public WpfControllerSpec_CommandHandlerInjection_AttributedToMethod()
        {
        ...
        void Ex01()
        {
            ...
            Given("a controller that has command handlers", () => WpfRunner.Run((application, context) =>
            {
                ...
                context.Set(ControllerKey, new TestWpfControllers.AttributedToMethod.OneArgumentExecutedOnlyHandlerController(HandleExecutedEvent));
            }));

            When("the controller is added", () => WpfRunner.Run((application, context) => WpfController.GetControllers(context.Get<TestElement>(ElementKey)).Add(context.Get<TestWpfControllers.AttributedToMethod.OneArgumentExecutedOnlyHandlerController>(ControllerKey))));
        ...
        void Ex02()
        {
            ...
            Given("a controller that has command handlers", () => WpfRunner.Run((application, context) =>
            {
                ...
                context.Set(ControllerKey, new TestWpfControllers.AttributedToMethod.OneArgumentExecutedAndCanExecuteHandlerController(HandleExecutedEvent, HandleCanExecuteEvent));
            }));

            When("the controller is added", () => WpfRunner.Run((application, context) => WpfController.GetControllers(context.Get<TestElement>(ElementKey)).Add(context.Get<TestWpfControllers.AttributedToMethod.OneArgumentExecutedAndCanExecuteHandlerController>(ControllerKey))));
            When("the controller is attached to the element", () => WpfRunner.Run((application, context) => WpfController.GetControllers(context.Get<TestElement>(ElementKey)).AttachTo(context.Get<TestElement>(ElementKey))));
            When("the Initialized event is raised", () => WpfRunner.Run((application, context) => context.Get<TestElement>(ElementKey).RaiseInitialized()));
        ...
        void Ex03()
        {
            ...
            Given("a controller that has command handlers", () => WpfRunner.Run((application, context) =>
            {
                ...
                context.Set(ControllerKey, new TestWpfControllers.AttributedToMethod.OneArgumentExecutedAndCanExecuteHandlerController(HandleExecutedEvent1, HandleCanExecuteEvent1, HandleExecutedEvent2, HandleCanExecuteEvent2));
            }));
        ...
        void Ex04()
        {
            ...
            Given("a controller that has command handlers", () => WpfRunner.Run((application, context) =>
            {
                ...
                context.Set(ControllerKey, new TestWpfControllers.AttributedToMethod.ExecutedOnlyHandlerController(HandleExecutedEvent));
            }));

            When("the controller is added", () => WpfRunner.Run((application, context) => WpfController.GetControllers(context.Get<TestElement>(ElementKey)).Add(context.Get<TestWpfControllers.AttributedToMethod.ExecutedOnlyHandlerController>(ControllerKey))));
            When("the controller is attached to the element", () => WpfRunner.Run((application, context) => WpfController.GetControllers(context.Get<TestElement>(ElementKey)).AttachTo(context.Get<TestElement>(ElementKey))));
            When("the Initialized event is raised", () => WpfRunner.Run((application, context) => context.Get<TestElement>(ElementKey).RaiseInitialized()));
        ...
        void Ex05()
        {
            ...
            Given("a controller that has command handlers", () => WpfRunner.Run((application, context) =>
            {
                ...
                context.Set(ControllerKey, new TestWpfControllers.AttributedToMethod.ExecutedAndCanExecuteHandlerController(HandleExecutedEvent, HandleCanExecuteEvent));
            }));

            When("the controller is added", () => WpfRunner.Run((application, context) => WpfController.GetControllers(context.Get<TestElement>(ElementKey)).Add(context.Get<TestWpfControllers.AttributedToMethod.ExecutedAndCanExecuteHandlerController>(ControllerKey))));
            When("the controller is attached to the element", () => WpfRunner.Run((application, context) => WpfController.GetControllers(context.Get<TestElement>(ElementKey)).AttachTo(context.Get<TestElement>(ElementKey))));
            When("the Initialized event is raised", () => WpfRunner.Run((application, context) => context.Get<TestElement>(ElementKey).RaiseInitialized()));
        ...
        void Ex06()
        {
            ...
            Given("a controller that has command handlers", () => WpfRunner.Run((application, context) =>
            {
                ...
                context.Set(ControllerKey, new TestWpfControllers.AttributedToMethod.ExecutedAndCanExecuteHandlerController(HandleExecutedEvent1, HandleCanExecuteEvent1, HandleExecutedEvent2, HandleCanExecuteEvent2));
            }));
