...
namespace Charites.Windows.Mvc
{
    ...
    class WpfControllerSpec_CommandHandlerInjection_AttributedToMethod : FixtureSteppable
    {
        ...
        void Ex01()
        {
            TestWpfControllers.AttributedToMethod.OneArgumentExecutedOnlyHandlerController controller = null;
            ...
            Given("a controller that has command handlers", () =>
            {
                ...
                controller =new TestWpfControllers.AttributedToMethod.OneArgumentExecutedOnlyHandlerController(HandleExecutedEvent);
            });
        ...
        void Ex02()
        {
            TestWpfControllers.AttributedToMethod.OneArgumentExecutedAndCanExecuteHandlerController controller = null;
            ...
            Given("a controller that has command handlers", () =>
            {
                ...
                controller = new TestWpfControllers.AttributedToMethod.OneArgumentExecutedAndCanExecuteHandlerController(HandleExecutedEvent, HandleCanExecuteEvent);
            });
        ...
        void Ex03()
        {
            ...
            Given("a controller that has command handlers", () =>
            {
                ...
                controller = new TestWpfControllers.AttributedToMethod.OneArgumentExecutedAndCanExecuteHandlerController(HandleExecutedEvent1, HandleCanExecuteEvent1, HandleExecutedEvent2, HandleCanExecuteEvent2);
            });
        ...
        void Ex04()
        {
            TestWpfControllers.AttributedToMethod.ExecutedOnlyHandlerController controller = null;
            ...
            Given("a controller that has command handlers", () =>
            {
                ...
                controller = new TestWpfControllers.AttributedToMethod.ExecutedOnlyHandlerController(HandleExecutedEvent);
            });
        ...
        void Ex05()
        {
            TestWpfControllers.AttributedToMethod.ExecutedAndCanExecuteHandlerController controller = null;
            ...
            Given("a controller that has command handlers", () =>
            {
                ...
                controller = new TestWpfControllers.AttributedToMethod.ExecutedAndCanExecuteHandlerController(HandleExecutedEvent, HandleCanExecuteEvent);
            });
        ...
        void Ex06()
        {
            ...
            Given("a controller that has command handlers", () =>
            {
                ...
                controller = new TestWpfControllers.AttributedToMethod.ExecutedAndCanExecuteHandlerController(HandleExecutedEvent1, HandleCanExecuteEvent1, HandleExecutedEvent2, HandleCanExecuteEvent2);
            });
